...
const FALLBACK = [
  { id:1, title:'Traditional Kandyan Dance Night',   date:'2026-06-27', time:'7:00 PM',  location:'Garden Amphitheatre', type:'Cultural',  spots:40, price:'$15', description:'A live performance of fire dances, drumming and the famed Kandyan dance, followed by a short storytelling session on Sri Lanka\u2019s ancient temple traditions.', image:'https://images.unsplash.com/photo-1583244532610-2a5f1fcc8c66?w=800&q=80&auto=format&fit=crop' },
  { id:2, title:'Full Moon Poya Lantern Evening',     date:'2026-07-01', time:'6:30 PM',  location:'Lotus Pond Lawn',     type:'Festival',  spots:60, price:'Free', description:'Mark the Poya with our guests \u2014 lantern lighting, a short meditation, and traditional sweets served beneath the full moon over the lotus pond.', image:'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=800&q=80&auto=format&fit=crop' },
  ...
  { id:5, title:'Anuradhapura Heritage Day Trip',     date:'2026-07-12', time:'8:00 AM',  location:'Ancient City Sites',  type:'Excursion', spots:15, price:'$45', description:'A guided tour of the sacred city\u2019s dagobas, ancient irrigation tanks and the Sri Maha Bodhi tree, with a traditional rice-and-curry lunch.', image:'https://images.unsplash.com/photo-1605649487212-47bdab064df7?w=800&q=80&auto=format&fit=crop' },
